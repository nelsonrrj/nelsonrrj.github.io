...
<template>
  <section>
    ...
    <p class="text-pretty">
      ...
      tecnologías, incluyendo Laravel, Vuejs, Angular, React, Node-Express,
      entre otras. Mi enfoque está en crear soluciones eficientes y escalables
      que impulsen el éxito y faciliten la vida de las personas.
    </p>
  </section>
</template>
